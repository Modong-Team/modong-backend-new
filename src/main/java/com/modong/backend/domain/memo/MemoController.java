...
public class MemoController {
  ...
  @PostMapping("/applicants/{applicant_id}/memos")//메모 생성 API
  ...
  public ResponseEntity createMemo(@Validated @RequestBody MemoCreateRequest memoCreateRequest, @Auth Long memberId, @PathVariable(name = "applicant_id") Long applicantId){
    SavedId savedId = new SavedId(memoService.create(memoCreateRequest,memberId,applicantId));
  ...
  @PutMapping("/applicants/{applicant_id}/memos/{memo_id}")//메모 수정 API
  ...
  public ResponseEntity updateMemo(@Validated @RequestBody MemoUpdateRequest memoUpdateRequest, @Validated @PathVariable(name = "memo_id") Long memoId, @Auth Long memberId, @PathVariable(name = "applicant_id") Long applicantId){
  ...
  @DeleteMapping("/applicants/{applicant_id}/memos/{memo_id}")//메모 삭제 API
  ...
  public ResponseEntity deleteMemo(@Validated @PathVariable(name = "memo_id") Long memoId, @Auth Long memberId,  @PathVariable(name = "applicant_id") Long applicantId){
  ...
  @GetMapping("/applicants/{applicant_id}/memos")//메모 조회 API
  ...
  public ResponseEntity getMemosByApplicant(@Validated @PathVariable(name = "applicant_id") Long applicantId, @Auth Long memberId){
    List<MemoResponse> memos = memoService.findAllByApplication(applicantId,memberId);
